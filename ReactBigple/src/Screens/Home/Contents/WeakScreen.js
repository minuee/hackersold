                                ...
                                return (
                                    <View key={index} style={[styles.gridView,index%2 == 0 ? styles.gridViewLeft : styles.gridViewRight ]} >
                                        <TouchableHighlight 
                                            ...
                                            onPress= {()=> this.props.screenProps.goBaseTestScreen(data.index,data.title)}>        
                                            <Image
                                        ...
                                        <View style={styles.imageTextTitle}>
                                            <TouchableHighlight onPress= {()=> this.props.screenProps.goBaseTestScreen(ata.index,data.title)}>
