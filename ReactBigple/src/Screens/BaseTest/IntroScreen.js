...
class IntroScreen extends React.Component {
    ...
    UNSAFE_componentWillMount() {
        ...
        const idx = this.props.selectBook.selectBookIndex ? this.props.selectBook.selectBookIndex : 1 
    ...
    componentDidMount() {      
        ...
        if ( this.state.lectureInfo === null && this.state.isLoading === false) {
            console.log('required lecture info')
                        ...
                        <View style={[styles.headerTitle,CommonStyle.mt20]}>
                            <View style={[styles.subjectImage]}>
                                <Image 
                                    ...
                                    style={{width: '100%',height : 150,borderColor : '#fff',borderWidth : 1}} 
                                    resizeMode='contain' 
                                />
                                {/*
