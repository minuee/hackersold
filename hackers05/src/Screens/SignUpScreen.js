                ...
                <Modal
                    ...
                    <View style = {styles.modalContent}>
                        <DateTimePicker
                            ...
                            date={this.state.basedate ? this.state.basedate : new Date(new Date().getFullYear() - 18 + '') }
            ...
            return (
                <GiftedForm
                    ...
                    openModal={route => {
                        ...
                        if ( route.getTitle() == 'Birthday' && Platform.OS === 'android') {
                    ...
                    defaults={{
                        ...
                        password: 'abcdefg',
                        country: 'FR',
                        birthday: moment(this.state.basedate).format('YYYY-MM-DD')//this.props.user_birthday !== null ? this.props.user_birthday : new Date(new Date().getFullYear() - 18 + '')
                    }}
                    validators={{
                        fullName: {
                            title: 'Full name',
                ...
                >
                        ...
                        onSubmit={(isValid,
                            ...
                            if (isValid === true) {
                                ...
                                /* Implement the request to your server using values variable
                                     ...
                                     */
                                this.state.isuploading ? postSubmit() : this._postSubmit();
                            }
                        }}
                    />
                    ...
                    {this.state.lastSubmitValues && <Text>Last submitted value:</Text>}
                    {this.state.lastSubmitValues && <Text>{JSON.stringify(this.state.lastSubmitValues, 0, 2)}</Text>}
                </GiftedForm>
            );
        }
    }
