...
class CalendarFooterComponent extends React.PureComponent {
    ...
    render() {
        const highDemandImage = require('../../assets/images/high-demand.png');
