            ...
            <SafeAreaView style={ styles.container }>
                ...
                >
                    ...
                    <View style={styles.middleWarp}>
                        ...
                        <View style={[styles.middleDataWarp,{}]}>                            
                            ...
                            { 
                                ...
                                <View style={styles.dataInputWrap3}>
                                    ...
                                    />                           
                                    <CustomTextM style={{fontSize:PixelRatio.roundToNearestPixel(DEFAULT_TEXT.fontSize13),color:'#808080'}}>승인처리</CustomTextM>
                                </View>  
                            }
                        </View> 
                        { 
                        ...
                        { 
                            !CommonUtil.isEmpty(this.state.formApproval) && 
                            <View style={[styles.middleDataWarp,{paddingBottom:15}]}>                            
                                <View style={[styles.titleWrap,{paddingBottom:10}]}>
