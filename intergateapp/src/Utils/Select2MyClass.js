...
import { Text, StyleSheet, TouchableOpacity, View, FlatList, TextInput, Dimensions, Animated, Platform, PixelRatio} from 'react-native';
...
// create a component
class Select2MyClass extends Component {
    static defaultProps = {
...
const styles = StyleSheet.create({
    ...
    itemText: {
        fontSize: PixelRatio.roundToNearestPixel(getDEFAULT_CONSTANTS.DEFAULT_TEXT.body_13), color: '#333', flex: 1
    },
    itemIcon: {
