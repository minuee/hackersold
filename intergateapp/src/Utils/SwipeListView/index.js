// https://github.com/jemise111/react-native-swipe-list-view/blob/master/components/SwipeListView.js
        ...
        if (!HiddenComponent) {
            ...
            return (
                <SwipeRow
                    ...
                    forceCloseToLeftThreshold={this.props.forceCloseToLeftThreshold}
                    forceCloseToRightThreshold={this.props.forceCloseToRightThreshold}
                >
                    {HiddenComponent}
                    {VisibleComponent}
                </SwipeRow>
