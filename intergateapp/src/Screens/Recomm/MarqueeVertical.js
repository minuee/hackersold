...
import { View, Animated, Easing, Text, TouchableOpacity, Image,InteractionManager } from 'react-native';
...
export default class MarqueeVertical extends Component {
    ...
    singleLineTextView(list){
        ...
        for(let i = 0;i<mlist.length;i++){
            ...
            itemView.push(
                <TouchableOpacity                     
                    key = {i} activeOpacity = {0.9} onPress = {() => {
                    onTextClick(item);                    
                }}>
                <View style = {{
                    ...styles.viewStyle,
                    ...
                    <Image source={require('../../../assets/icons/icon_noti_dday.png')} style={{width: 18, height: 13}} resizeMode='contain' /> 
                    <Text style = {{
                        ...styles.textStyle,
                        ...textStyle
                    }} numberOfLines = {numberOfLines}>
                         {"  "}
                        {item.subject} D-{item.dDay}
                        </Text>
                </View>
                </TouchableOpacity>
            );
