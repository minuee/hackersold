...
import { CustomTextM,TextRobotoM,TextRobotoR, CustomTextR }   from '../../Style/CustomText';
import CommonUtil from '../../Utils/CommonUtil';
import CommonFuncion from '../../Utils/CommonFunction';

const {height: SCREEN_HEIGHT, width: SCREEN_WIDTH} = Dimensions.get('window');

export default  class FamilySiteList extends Component {
    constructor(props) {
        super(props);

        this.state = {
            loading : true,
            itemList: props.screenState.contentItems.sns.HACKERSFAMILY || []
        }

        console.log('FamilySiteList', 'HACKERSFAMILY = ' + JSON.stringify(props.screenState.contentItems.sns.HACKERSFAMILY))
    }
    ...
    render() {
        if ( false ) {
            ...
            return(
                <View style={[
                    styles.container,
                    this.state.itemList.length === 0 && {height: 300}
                ]}>
                    <NavigationEvents
                        onWillFocus={payload => {
                            ...
                            return(                           
                                <View
                                    ...
                                    <View style={{flex:5}}>
                                        ...
                                        <TextRobotoM
                                            style={{
                                                ...
                                                //lineHeight: PixelRatio.roundToNearestPixel(7.4),
                                                letterSpacing: 0.55,
                                                paddingBottom: 10,
                                            }}
                                            numberOfLines={1}
                                    ...
                                    <TouchableOpacity
                                        ...
                                        >
                                        <Image
                                            source={require('../../../assets/icons/btn_external_link.png')}
                                            style={{
