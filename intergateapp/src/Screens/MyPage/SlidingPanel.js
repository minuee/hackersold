  ...
  UNSAFE_componentWillMount() {
    ...
    this.state.panResponder = PanResponder.create({
      ...
      onPanResponderGrant: (evt, gestureState) => {
        ...
        //this.props.onMoveTop(gestureState.y0);
        
      },
      onPanResponderMove: (event, gestureState) => {
        
        //console.log('onPanResponderMove', gestureState)
        this.props.onMoveTop(gestureState);
        this.props.onScrollHeight(this.state.heightAnim,gestureState);
        //console.log('ddddd',this.state.heightAnim);
        /*
        if ( event.nativeEvent.pageY < this.props.setChangePosition  ) {
            console.log('ddddd',this.state.heightAnim);
            Animated.timing(
                this.state.heightAnim,
                {
                    ...
                    this.props.onDragStop(event, gestureState);
                    console.log('xxxxxx');
                    this.props.onMoveTop(true);
                });
        }else{
            this.props.onMoveTop(false);
        }
        */
        if(this.props.allowDragging) {
          ...
          if((Platform.OS === 'android' ? sliderPosition + a < ( this.props.slidingPanelLayoutHeight ? this.props.slidingPanelLayoutHeight : height - (this.props.headerLayoutHeight + 5)) : sliderPosition + a < ( this.props.slidingPanelLayoutHeight ? this.props.slidingPanelLayoutHeight :  height - (this.props.headerLayoutHeight -2))) && sliderPosition + a > -2){
            if(sliderPosition !== 0) {
      ...
      onPanResponderRelease        : (e, gesture) => {
        ...
        //this.props.onMoveTop(gesture.y0);
        /*
        if ( e.nativeEvent.pageY < this.props.setChangePosition  ) {
            this.props.onMoveTop(e.nativeEvent.pageY,0,1);
        }else{
            this.props.onMoveTop(e.nativeEvent.pageY,0,0);
          ...
          if(a === 0 || (this.props.panelPosition === 'bottom' ? gesture.vy < -1 : gesture.vy > 1)) {
            if(sliderPosition < ( this.props.slidingPanelLayoutHeight ? this.props.slidingPanelLayoutHeight : height-this.props.headerLayoutHeight)) {
              ...
              Animated.timing(
                ...
                this.props.onMoveTop2(true)
                
                }
              );
              //this.props.onMoveTop(this.state.heightAnim,Platform.OS === 'android' ? ( this.props.slidingPanelLayoutHeight ? this.props.slidingPanelLayoutHeight : height-this.props.headerLayoutHeight - 25) : (this.props.slidingPanelLayoutHeight ? this.props.slidingPanelLayoutHeight : height-this.props.headerLayoutHeight),3);
            }
            else {
              sliderPosition = 0
              this.props.onAnimationStart();
