    ...
    return (
      ...
      >
          <ImageBackground
                ...
                style={{height: '100%', width:SCREEN_WIDTH, opacity: 0.8,transform: [{ scale: 1 }]}}
                blurRadius={Platform.OS === 'ios' ? 15 : 5}
                >
                {/*gradient*/}
                <LinearGradient
                    // colors={["rgba(255,255,255,0.9)", "rgba(255,255,255,0.35)", "rgba(255,255,255,0)"]}
                    colors={["rgba(100,100,100,0.9)", "rgba(100,100,100,0.35)", "rgba(100,100,100,0)"]}
                    locations={[0, 0.25, 1]}
            ...
            (
                <View style={{flexDirection :'row',flexGrow:1,zIndex:2,justifyContent:'center',paddingTop:Platform.OS === 'android' ? 25 : 35,paddingHorizontal:25}}>
                    <View 
                        ...
                        <Image source={{uri:markImage}} style={{width:SCREEN_WIDTH/3-4,height:(SCREEN_WIDTH/3)*4/3}} resizeMode='contain' />
                    </View>
                    <View style={{flex:1.5,paddingLeft:30,justifyContent:'center'}}>
                        <CustomTextB 
                            numberOfLines={4} ellipsizeMode = 'tail'
                            style={{
                              fontSize:PixelRatio.roundToNearestPixel(19), color: 'white', paddingBottom: 5,
                              lineHeight: 19 * 1.42,
                              letterSpacing: -1.14,
                              // ...Platform.select({ 
                              //   ios: { shadowColor: '#222222', shadowOffset: { width: 4, height: 4, }, shadowOpacity: 0.3, shadowRadius: 4, }, 
                              //   android: { elevation: 4, }, }),
                            }}>
                          {lectureName}
                        </CustomTextB>
        ...
        return (
          ...
          {leftIcon &&
            ...
            >
              ...
              /> */}
              <TouchableOpacity onPress={leftIconOnPress} style={{paddingLeft: 10}}>
          ...
          {centerTitle &&
            <View style={{
                ...
                paddingTop : Platform.OS === 'ios' ? 0 : 15,                
                  ...
                  {this.state.showBottomBar?   
                    <View>              
                      ...
                      <View
                        // style={{position:'absolute',top:Platform.OS === 'ios' ? 15 : navBarHeight/2,left:SCREEN_WIDTH/2-navBarHeight,width:navBarHeight-10,height:navBarHeight-10,borderRadius:(navBarHeight-10)/2,borderColor:'#fff',borderWidth:2,alignItems:'center',justifyContent:'center',overflow:'hidden',backgroundColor:'#fff'}}
                        ...
                        style={{position:'absolute',top:Platform.OS === 'ios' ? 15 : navBarHeight/2-10,left:SCREEN_WIDTH/3,width:navBarHeight-10,height:navBarHeight-10,borderRadius:(navBarHeight-10)/2,borderColor:'#fff',borderWidth:2,alignItems:'center',justifyContent:'center',overflow:'hidden',backgroundColor:'transparent'}}
                      >
                ...
                :
                    <CustomTextR style={{color:DEFAULT_COLOR.base_color_fff,fontSize:PixelRatio.roundToNearestPixel(DEFAULT_TEXT.head_small)}}>
                        {centerTitle}
                    </CustomTextR>
                }
            </View>
