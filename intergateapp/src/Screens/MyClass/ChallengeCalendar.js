...
import ChallengeCalendarContainer from './ChallengeCalendarContainer';
...
export default class ChallengeCalendar extends Component {
  constructor(props) {
    super(props);
    this.state = {
      attendHistory: [],
      ...
      <View style={styles.container}>
        ...
        <ScrollView ref={ref => this.scrollViewRef = ref}>
          ...
          //Calendar
            ...
            firstDay={0}
            goScrollBottom={this.goScrollBottom}
          />
        </ScrollView>
      </View>
    );
